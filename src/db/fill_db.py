...
author1 = Author(name='Anna', age=29)
author2 = Author(name='Pavel', age=33)
author3 = Author(name='Inga', age=56)

session.add_all([author1, author2, author3])
session.commit()

# Заполняю таблицу posts
post1 = Post(title='title_1', body='body_1', short_body='short_body_1', author_id=author1.id)
post2 = Post(title='title_2', body='body_2', short_body='short_body_2', author_id=author2.id)
post3 = Post(title='title_3', body='body_3', short_body='short_body_3', author_id=author3.id)
post4 = Post(title='title_4', body='body_4', short_body='short_body_4', author_id=author1.id)
